...
Object.defineProperties( PlayerController.prototype, {
  ...
  valid: {
    get: function() { return this.sync.positionUpdated && this.master.updated; },
    set: function( v ) { this.sync.positionUpdated = this.master.updated = v }
  },
  ...
  seekToMaster: { value: function() {
    if ( this.waiting || ! this.valid ) return;
